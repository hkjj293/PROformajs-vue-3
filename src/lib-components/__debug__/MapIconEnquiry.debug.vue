...
const testPRProps1 = {
    ...
    y: 50,
    stroke_width: 8,
    stroke: task_colors.enquiry.done,
    fill: task_colors.enquiry.done,
    animate: true
}

export default {
    name: "MapIconEnquiryDebug",
    data: function () {
        return {
