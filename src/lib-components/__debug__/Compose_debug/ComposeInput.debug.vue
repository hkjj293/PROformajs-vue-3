<docs>
    Debug for ComposeInput
</docs>

<template>
    <div>
        <debug title="ComposeInput">
            <ComposeInput att="caption" :comp="task" @change-attribute="updateAttribute" />
        </debug>
    </div>
</template >

<script>
import ComposeInput from '../../Compose/ComposeInput.vue'
