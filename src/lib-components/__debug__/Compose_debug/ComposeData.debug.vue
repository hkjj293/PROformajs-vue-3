<docs>ComposeData
    Debug for ComposeData
</docs>

<template>
    <div>
        <debug title="ComposeData">
            <ComposeData :protocol="protocol" :path="dataDefinitionPath" :issues="subComponentIssues(dataDefinitionPath)"
...
<script>
import ComposeData from '../../Compose/ComposeData.vue'
