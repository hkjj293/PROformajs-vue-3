<docs>
    Debug for ComposeName
</docs>

<template>
    <div>
        <debug title="ComposeName">
            <ComposeName :comp="task" @change-attribute="updateAttribute" />
        </debug>
    </div>
</template >

<script>
import ComposeName from '../../Compose/ComposeName.vue'
