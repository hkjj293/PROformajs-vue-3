<docs>
    Debug for ComposeTextArea
</docs>

<template>
  <div>
    <debug title="ComposeTextArea">
      <ComposeTextArea att="caption" :comp="task" @change-attribute="updateAttribute" />
    </debug>
  </div>
</template>

<script>
import ComposeTextArea from '../../Compose/ComposeTextArea.vue'
