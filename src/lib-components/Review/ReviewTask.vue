        ...
        <div class="row g-0">
          ...
          <div class="col">
            ...
            <pr-markdown v-if="showCandidateDescriptionInline && candidate.description" :text="candidate.description"
              class="mb-1 markdown" />
            <PopoverButton v-if="!showCandidateDescriptionInline && candidate.description"
              :content="candidate.description" class="pb-1 pt-0 pe-0">
          ...
          <div class="col">
            <div v-if="argument.active">
              ...
              <template v-if="argument.description">
                ...
                <template v-else>
                  <PopoverButton :content="argument.description" class="btn-link btn-sm pb-1 pt-0">
                    <font-awesome-icon icon="info-circle" />
                  </PopoverButton>
                </template>
              </template>
