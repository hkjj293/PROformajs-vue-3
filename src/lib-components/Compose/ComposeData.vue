...
<template>
  <div>
    ...
    <ul class="nav nav-tabs small" :id="'pc-arg-tabs-' +
      (this.def && this.def.name ? this.def.name.replaceAll(':', '-') : 'no-name')
      " role="tablist">
    ...
    <div class="tab-content mt-2">
      <div :class="'tab-pane ' + (tabIndex == 0 ? 'active' : '')" id="pc-data-tabs-details-p">
        <form>
      ...
      <div :class="'tab-pane ' + (tabIndex == 1 ? 'active' : '')" id="pc-data-tabs-value-p">
        <form>
