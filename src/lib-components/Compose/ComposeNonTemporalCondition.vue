...
<template>
  <div class="form-group">
    ...
    <input :type="typeValue" class="form-control form-control-sm"
      v-bind:class="{ 'is-invalid': hasValue && valid === false, 'is-valid': hasValue && valid === true }" :id="att"
      :value="nonTemporalClauses(comp[att])" @change="updateClauses(att, $event.target.value)" :disabled="disabled">
